...
import { coinaddress, nftaddress } from '../../config';
            ...
            <nav data-aos="zoom-out" data-aos-delay={800} className="navbar navbar-expand">
                <div className="container header">
                    ...
                    <ul className="navbar-nav items mx-auto" style={{ position: "" }}>
                        ...
                        <li className="nav-item dropdown">
                            <Link className="nav-link" to="/sell-assets">Marketplace</Link>
                        </li>
                        <li className="nav-item dropdown">
                            <Link className="nav-link" to="/my-assets">My NFTs</Link>
                        </li>
                        <li className="nav-item dropdown">
                            <li className="nav-item"><Link to="/create-nft" className="nav-link">Mint NFTs</Link></li>
                        </li>
                        {
                            String(localStorage.getItem('select-address')).toLowerCase() === String(contractOwner).toLowerCase() && (
                                <li className="nav-item dropdown">
                                    <li className="nav-item"><Link to="/create-collection" className="nav-link">Create Collections</Link></li>
                                </li>
                            )
                        }
                        {/* <li className="nav-item dropdown">
                        ...
                        {(walletAddress != '') && (
                            <li className="nav-item">
                                <div className='text-center d-inline-block'>
                                    <p className="nav-link my-0 p-0" style={{ color: 'grey' }}>{walletAddress}</p>
                                    <p className="nav-link my-0 p-0" style={{ color: 'grey' }}>({myBalance} ADMC)</p>
                                </div>
                            </li>
                        )}
                    </ul>
