...
contract NFTMarket is ReentrancyGuard {
    ...
    function giftNFT(
        ...
        require(
            _to != idToMarketItem[_itemId].owner,
            "You can't gift your NFT to you."
        );

        IERC721(nftContract).approve(_to, marketItem.tokenId);
    ...
    function _transferFrom(
        ...
        address nftOwner = idToMarketItem[_itemId].owner;

        m_mapAddressToOwns[nftOwner][_collectionId] =
            m_mapAddressToOwns[nftOwner][_collectionId] -
            1;
        m_mapAddressToOwns[_to][_collectionId] =
            m_mapAddressToOwns[_to][_collectionId] +
            1;

        idToMarketItem[_itemId].owner = payable(_to);
        idToMarketItem[_itemId].seller = payable(_to);
        idToMarketItem[_itemId].sold = false;
        idToMarketItem[_itemId].price = 0;

        IERC721(nftContract).safeTransferFrom(owner, _to, _tokenId);
        emit Transfer(owner, _to, _tokenId, _collectionId);
